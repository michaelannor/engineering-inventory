...
/*
*@method view_log_equipment_fault() a view that contains log equipment fault form
*/
function view_log_equipment_fault(){
	var content="";
	content+="<div class='form-group'><label for='equipment'>Equipment Name </label><input type='text' id='nm' class='form-control' placeholder='Enter Equipment Name' required></div>";
	content+="<div class='form-group'><label for='id'> Equipment ID</label><input type='text' id='tp' class='form-control' placeholder='Enter Equipment ID' required></div>";
	content+="<div class='form-group'><label for='lab'>Lab ID</label><input type='text' id='lb' class='form-control' placeholder='Enter Lab ID' required></div>";
	content+="<div class='form-group'><label for='description'>Description</label><input type='text' id='dp' class='form-control' placeholder='Enter Description' required></div>";
	content+=" <div class='form-group'><label for='date'>Date of Damage</label><input type='date' id='dt' class='form-control' placeholder='YYYY/MM/DD' required></div>";
	content +="<button id=log_equipment_fault_btn' onclick='log_equipment_fault()' class='btn btn-primary btn-lg btn-block' > Log Fault</button>";
   $("#main-content").html(content);
}
...
/*
*@method log_equipment_fault() a method that calls an ajax command to verify and authorize logging a faulty equipment
*/
function log_equipment_fault() {
